...
if(NOT EXISTS "${CMAKE_CURRENT_LIST_DIR}/../../Headers/SDL_mixer.h")
    message(AUTHOR_WARNING "Could not find SDL_mixer.h. This script is meant to be placed in the Resources/CMake directory of SDL2_mixer.framework")
    return()
endif()

file(READ "${CMAKE_CURRENT_LIST_DIR}/../../Headers/SDL_mixer.h" _sdl_mixer_h)
